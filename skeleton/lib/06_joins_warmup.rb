...
def casablanca_cast
  ...
  execute(<<-SQL)
  SELECT DISTINCT name FROM actors AS a JOIN castings as c ON a.id = c.actor_id WHERE c.movie_id = (SELECT id FROM movies WHERE title = 'Casablanca')
  SQL
end
...
def alien_cast
  ...
  execute(<<-SQL)
  SELECT DISTINCT name FROM actors AS a JOIN castings as c ON a.id = c.actor_id WHERE c.movie_id = (SELECT id FROM movies WHERE title = 'Alien')
  SQL
end
